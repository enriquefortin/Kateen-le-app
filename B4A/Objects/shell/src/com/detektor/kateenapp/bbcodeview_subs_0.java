...
try {
		Debug.PushSubsStack("Base_Resize (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,105);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_parseanddraw" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 113;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_redraw" /*RemoteObject*/ );
 };
 };
...
bbcodeview._style = RemoteObject.createNew ("com.detektor.kateenapp.bctextengine._bcparagraphstyle");__ref.setField("_style",bbcodeview._style);
 //BA.debugLineNum = 12;BA.debugLine="Private mTextEngine As BCTextEngine";
bbcodeview._mtextengine = RemoteObject.createNew ("com.detektor.kateenapp.bctextengine");__ref.setField("_mtextengine",bbcodeview._mtextengine);
...
bbcodeview._paragraph = RemoteObject.createNew ("com.detektor.kateenapp.bctextengine._bcparagraph");__ref.setField("_paragraph",bbcodeview._paragraph);
...
bbcodeview._parsedata = RemoteObject.createNew ("com.detektor.kateenapp.bbcodeparser._bbcodeparsedata");__ref.setField("_parsedata",bbcodeview._parsedata);
...
bbcodeview._usedimageviews = RemoteObject.createNew ("com.detektor.kateenapp.b4xorderedmap");__ref.setField("_usedimageviews",bbcodeview._usedimageviews);
...
try {
		Debug.PushSubsStack("CleanExistingImageViews (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,205);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_invisibleonly,bbcodeview.__c.getField(true,"False")) || RemoteObject.solveBoolean("=",__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_lineisvisible" /*RemoteObject*/ ,(Object)(_line),(Object)(_offset),(Object)(_height)),bbcodeview.__c.getField(true,"False"))) { 
...
_xiv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_line))));Debug.locals.put("xiv", _xiv);Debug.locals.put("xiv", _xiv);
...
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_line)));};
 };
 }
}Debug.locals.put("Line", _line);
;
...
try {
		Debug.PushSubsStack("CollectURLs (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,327);
...
RemoteObject _st = RemoteObject.declareNull("com.detektor.kateenapp.bctextengine._bcsinglestylesection");
RemoteObject _extra = RemoteObject.declareNull("com.detektor.kateenapp.bbcodeview._internalbbviewurl");
...
Debug.JustUpdateDeviceLine();
_extra = RemoteObject.createNew ("com.detektor.kateenapp.bbcodeview._internalbbviewurl");Debug.locals.put("extra", _extra);
...
Debug.JustUpdateDeviceLine();
_extra = __ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_createbcurlextradata" /*RemoteObject*/ );Debug.locals.put("extra", _extra);
...
try {
		Debug.PushSubsStack("CreateBCURLExtraData (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,348);
if (RapidSub.canDelegate("createbcurlextradata")) { return __ref.runUserSub(false, "bbcodeview","createbcurlextradata", __ref);}
RemoteObject _t1 = RemoteObject.declareNull("com.detektor.kateenapp.bbcodeview._internalbbviewurl");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("com.detektor.kateenapp.bbcodeview._internalbbviewurl");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("DesignerCreateView (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("DrawVisibleRegion (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("FindTouchedRun (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,292);
...
try {
		Debug.PushSubsStack("GetAnchorLine (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,196);
...
try {
		Debug.PushSubsStack("getText (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("getTextEngine (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,128);
...
try {
		Debug.PushSubsStack("getViews (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,51);
...
try {
		Debug.PushSubsStack("Initialize (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("LineIsVisible (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,201);
...
try {
		Debug.PushSubsStack("MarkURL (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,304);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_line))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 320;BA.debugLine="mTextEngine.DrawSingleLine(line, UsedImageVie";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bctextengine.class, "_drawsingleline" /*RemoteObject*/ ,(Object)(_line),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_line)))),(Object)(__ref.getField(false,"_paragraph" /*RemoteObject*/ )));
 };
 }
}Debug.locals.put("line", _line);
;
...
try {
		Debug.PushSubsStack("ParseAndDraw (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,218);
...
_pe = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bbcodeparser.class, "_parse" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ )));Debug.locals.put("pe", _pe);Debug.locals.put("pe", _pe);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_runs" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bbcodeparser.class, "_createruns" /*RemoteObject*/ ,(Object)(_pe),(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ ))));
 };
...
try {
		Debug.PushSubsStack("Redraw (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,239);
...
Debug.JustUpdateDeviceLine();
bbcodeview._style = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bctextengine.class, "_createstyle" /*RemoteObject*/ );__ref.setField("_style",bbcodeview._style);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_cleanexistingimageviews" /*RemoteObject*/ ,(Object)(bbcodeview.__c.getField(true,"False")),(Object)(__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 248;BA.debugLine="UsedImageViews.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_clear" /*RemoteObject*/ );
 BA.debugLineNum = 249;BA.debugLine="Paragraph = mTextEngine.PrepareForLazyDrawing(Ru";
Debug.JustUpdateDeviceLine();
__ref.setField ("_paragraph" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bctextengine.class, "_prepareforlazydrawing" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_runs" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_style" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_sv" /*RemoteObject*/ ))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_collecturls" /*RemoteObject*/ );
 };
 BA.debugLineNum = 254;BA.debugLine="DrawVisibleRegion";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_drawvisibleregion" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 256;BA.debugLine="Paragraph = mTextEngine.DrawText(Runs, Style, Fo";
Debug.JustUpdateDeviceLine();
__ref.setField ("_paragraph" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bctextengine.class, "_drawtext" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_runs" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_style" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_sv" /*RemoteObject*/ ))));
 };
...
try {
		Debug.PushSubsStack("ScrollToAnchor (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,178);
...
Debug.JustUpdateDeviceLine();
_line = __ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_getanchorline" /*RemoteObject*/ ,(Object)(_anchor));Debug.locals.put("line", _line);Debug.locals.put("line", _line);
...
try {
		Debug.PushSubsStack("setText (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,132);
...
try {
		Debug.PushSubsStack("setTextEngine (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,118);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("setViews (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("sv_ScrollChanged (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,362);
...
try {
		Debug.PushSubsStack("TouchPanel_Touch (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,263);
...
Debug.JustUpdateDeviceLine();
_run = __ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_findtouchedrun" /*RemoteObject*/ ,(Object)(_x),(Object)(_y));Debug.locals.put("run", _run);
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)((bbcodeview.__c.getField(false,"Null"))));
 }else 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)(_run));
 }}
;
...
try {
		Debug.PushSubsStack("UpdateVisibleRegion (bbcodeview) ","bbcodeview",56,__ref.getField(false, "ba"),__ref,147);
...
Debug.JustUpdateDeviceLine();
_existing.runVoidMethod ("AddAll",(Object)(__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ )));
 BA.debugLineNum = 152;BA.debugLine="CleanExistingImageViews(True, Existing, OffsetY,";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_cleanexistingimageviews" /*RemoteObject*/ ,(Object)(bbcodeview.__c.getField(true,"True")),(Object)(_existing),(Object)(_offsety),(Object)(_height));
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (com.detektor.kateenapp.bbcodeview.class, "_lineisvisible" /*RemoteObject*/ ,(Object)(_line),(Object)(_offsety),(Object)(_height)).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.bctextengine.class, "_drawsingleline" /*RemoteObject*/ ,(Object)(_line),(Object)(_xiv),(Object)(__ref.getField(false,"_paragraph" /*RemoteObject*/ )));
 BA.debugLineNum = 171;BA.debugLine="UsedImageViews.Put(Line, xiv)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_line)),(Object)((_xiv.getObject())));
 }else {
