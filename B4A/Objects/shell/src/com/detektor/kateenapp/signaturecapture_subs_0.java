...
try {
		Debug.PushSubsStack("Clear (signaturecapture) ","signaturecapture",12,_ba,signaturecapture.mostCurrent,19);
if (RapidSub.canDelegate("clear")) { return com.detektor.kateenapp.signaturecapture.remoteMe.runUserSub(false, "signaturecapture","clear", _ba, _sd);}
;
Debug.locals.put("SD", _sd);
 BA.debugLineNum = 19;BA.debugLine="Sub Clear(SD As SignatureData)";
...
try {
		Debug.PushSubsStack("Panel_Touch (signaturecapture) ","signaturecapture",12,_ba,signaturecapture.mostCurrent,7);
if (RapidSub.canDelegate("panel_touch")) { return com.detektor.kateenapp.signaturecapture.remoteMe.runUserSub(false, "signaturecapture","panel_touch", _ba, _sd, _x, _y, _action);}
;
Debug.locals.put("SD", _sd);
...
_sd.getField(false,"Canvas" /*RemoteObject*/ ).runVoidMethod ("DrawLine",(Object)(BA.numberCast(float.class, signaturecapture._px)),(Object)(BA.numberCast(float.class, signaturecapture._py)),(Object)(BA.numberCast(float.class, _x)),(Object)(BA.numberCast(float.class, _y)),(Object)(_sd.getField(true,"SignatureColor" /*RemoteObject*/ )),(Object)(BA.numberCast(float.class, _sd.getField(true,"SignatureWidth" /*RemoteObject*/ ))));
 BA.debugLineNum = 13;BA.debugLine="SD.Canvas.DrawCircle(px, py, SD.SignatureWidth/2";
Debug.ShouldStop(4096);
_sd.getField(false,"Canvas" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(BA.numberCast(float.class, signaturecapture._px)),(Object)(BA.numberCast(float.class, signaturecapture._py)),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_sd.getField(true,"SignatureWidth" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "/",0, 0))),(Object)(_sd.getField(true,"SignatureColor" /*RemoteObject*/ )),(Object)(signaturecapture.mostCurrent.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_sd.getField(true,"SignatureWidth" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "/",0, 0))));
 BA.debugLineNum = 14;BA.debugLine="SD.Panel.Invalidate";
Debug.ShouldStop(8192);
_sd.getField(false,"Panel" /*RemoteObject*/ ).runVoidMethod ("Invalidate");
 BA.debugLineNum = 15;BA.debugLine="px = x";
Debug.ShouldStop(16384);
signaturecapture._px = _x;
 BA.debugLineNum = 16;BA.debugLine="py = y";
...
try {
		Debug.PushSubsStack("Save (signaturecapture) ","signaturecapture",12,_ba,signaturecapture.mostCurrent,24);
if (RapidSub.canDelegate("save")) { return com.detektor.kateenapp.signaturecapture.remoteMe.runUserSub(false, "signaturecapture","save", _ba, _sd, _dir, _name);}
...
_out = signaturecapture.mostCurrent.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(_dir),(Object)(_name),(Object)(signaturecapture.mostCurrent.__c.getField(true,"False")));Debug.locals.put("out", _out);
 BA.debugLineNum = 27;BA.debugLine="SD.Canvas.Bitmap.WriteToStream(out, 100, \"PNG\")";
