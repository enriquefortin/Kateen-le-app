...
try {
		Debug.PushSubsStack("CreateBitSet (b4xcollections) ","b4xcollections",18,_ba,b4xcollections.mostCurrent,52);
if (RapidSub.canDelegate("createbitset")) { return com.detektor.kateenapp.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createbitset", _ba, _size);}
RemoteObject _s = RemoteObject.declareNull("com.detektor.kateenapp.b4xbitset");
;
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("com.detektor.kateenapp.b4xbitset");Debug.locals.put("s", _s);
 BA.debugLineNum = 54;BA.debugLine="s.Initialize(Size)";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (com.detektor.kateenapp.b4xbitset.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba),(Object)(_size));
...
try {
		Debug.PushSubsStack("CreateOrderedMap (b4xcollections) ","b4xcollections",18,_ba,b4xcollections.mostCurrent,30);
if (RapidSub.canDelegate("createorderedmap")) { return com.detektor.kateenapp.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap", _ba);}
;
...
try {
		Debug.PushSubsStack("CreateOrderedMap2 (b4xcollections) ","b4xcollections",18,_ba,b4xcollections.mostCurrent,38);
if (RapidSub.canDelegate("createorderedmap2")) { return com.detektor.kateenapp.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createorderedmap2", _ba, _keys, _values);}
RemoteObject _m = RemoteObject.declareNull("com.detektor.kateenapp.b4xorderedmap");
int _i = 0;
;
...
Debug.JustUpdateDeviceLine();
_m = RemoteObject.createNew ("com.detektor.kateenapp.b4xorderedmap");Debug.locals.put("m", _m);
 BA.debugLineNum = 40;BA.debugLine="m.Initialize";
Debug.JustUpdateDeviceLine();
_m.runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba));
...
Debug.JustUpdateDeviceLine();
_m.runClassMethod (com.detektor.kateenapp.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)(_keys.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),(Object)(_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))));
 }
}Debug.locals.put("i", _i);
;
 };
...
try {
		Debug.PushSubsStack("CreateSet (b4xcollections) ","b4xcollections",18,_ba,b4xcollections.mostCurrent,9);
if (RapidSub.canDelegate("createset")) { return com.detektor.kateenapp.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset", _ba);}
;
...
try {
		Debug.PushSubsStack("CreateSet2 (b4xcollections) ","b4xcollections",18,_ba,b4xcollections.mostCurrent,16);
if (RapidSub.canDelegate("createset2")) { return com.detektor.kateenapp.b4xcollections.remoteMe.runUserSub(false, "b4xcollections","createset2", _ba, _values);}
RemoteObject _s = RemoteObject.declareNull("com.detektor.kateenapp.b4xset");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("com.detektor.kateenapp.b4xset");Debug.locals.put("s", _s);
 BA.debugLineNum = 18;BA.debugLine="s.Initialize";
Debug.JustUpdateDeviceLine();
_s.runClassMethod (com.detektor.kateenapp.b4xset.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba));
...
Debug.JustUpdateDeviceLine();
_s.runClassMethod (com.detektor.kateenapp.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(_v));
 }
}Debug.locals.put("v", _v);
;
 };
