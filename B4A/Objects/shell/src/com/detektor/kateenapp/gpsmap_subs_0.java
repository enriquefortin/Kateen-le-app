...
public class gpsmap_subs_0 {


public static void  _addmap(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("AddMap (gpsmap) ","gpsmap",2,__ref.getField(false, "ba"),__ref,36);
...
Debug.ShouldStop(32);
parent.__c.runVoidMethod ("LogImpl","21310722",RemoteObject.createImmutable("====Map is ready===="),0);
...
parent.__c.runVoidMethod ("LogImpl","21310724",RemoteObject.createImmutable("mapa get"),0);
...
parent.__c.runVoidMethod ("LogImpl","21310747",BA.ObjectToString(__ref.getField(false,"_gmap" /*RemoteObject*/ ).runMethod(false,"getMyLocation")),0);
 if (true) break;
...
Debug.ShouldStop(2);
parent.__c.runVoidMethod ("LogImpl","21310750",RemoteObject.createImmutable("No permission!"),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("B4XPage_Created (gpsmap) ","gpsmap",2,__ref.getField(false, "ba"),__ref,21);
...
public static RemoteObject  _btnplace_click(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("btnplace_Click (gpsmap) ","gpsmap",2,__ref.getField(false, "ba"),__ref,86);
if (RapidSub.canDelegate("btnplace_click")) { return __ref.runUserSub(false, "gpsmap","btnplace_click", __ref);}
 BA.debugLineNum = 86;BA.debugLine="Private Sub btnplace_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 87;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"question";
Debug.ShouldStop(4194304);
gpsmap._b4xpages.runVoidMethod ("_showpageandremovepreviouspages" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("questioninterface")));
...
gpsmap._gmap = RemoteObject.createNew ("anywheresoftware.b4a.objects.MapFragmentWrapper.GoogleMapWrapper");__ref.setField("_gmap",gpsmap._gmap);
 //BA.debugLineNum = 8;BA.debugLine="Private pnlhora As B4XView";
gpsmap._pnlhora = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_pnlhora",gpsmap._pnlhora);
 //BA.debugLineNum = 9;BA.debugLine="Private pnlmenu As B4XView";
gpsmap._pnlmenu = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_pnlmenu",gpsmap._pnlmenu);
 //BA.debugLineNum = 10;BA.debugLine="Private Label2 As B4XView";
gpsmap._label2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_label2",gpsmap._label2);
 //BA.debugLineNum = 11;BA.debugLine="Private btnplace As B4XView";
gpsmap._btnplace = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_btnplace",gpsmap._btnplace);
 //BA.debugLineNum = 12;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba) throws Exception{
try {
		Debug.PushSubsStack("Initialize (gpsmap) ","gpsmap",2,__ref.getField(false, "ba"),__ref,16);
