...
public class activegps {
    public static RemoteObject myClass;
	public activegps() {
	}
    public static PCBA staticBA = new PCBA(null, activegps.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Button1",_ref.getField(false, "_button1"),"DateUtils",_ref.getField(false, "_dateutils"),"Root",_ref.getField(false, "_root"),"xui",_ref.getField(false, "_xui")};
}
}