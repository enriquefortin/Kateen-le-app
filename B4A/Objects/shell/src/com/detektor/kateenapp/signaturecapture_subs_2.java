...
public class signaturecapture_subs_2 {


public static RemoteObject  _clear(RemoteObject _ba,RemoteObject _sd) throws Exception{
try {
		Debug.PushSubsStack("Clear (signaturecapture) ","signaturecapture",12,_ba,signaturecapture.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Save (signaturecapture) ","signaturecapture",12,_ba,signaturecapture.mostCurrent,23);
...
_out = signaturecapture.mostCurrent.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(_dir),(Object)(_name),(Object)(signaturecapture.mostCurrent.__c.getField(true,"False")));Debug.locals.put("out", _out);
 BA.debugLineNum = 26;BA.debugLine="SD.Canvas.Bitmap.WriteToStream(out, 100, \"PNG\")";
