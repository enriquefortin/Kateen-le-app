...
try {
		Debug.PushSubsStack("Activity_ActionBarHomeClick (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,35);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_activity_actionbarhomeclick" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Activity_KeyPress (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,27);
...
Debug.JustUpdateDeviceLine();
if (true) return b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_activity_keypress" /*RemoteObject*/ ,(Object)(_keycode));
...
try {
		Debug.PushSubsStack("Activity_Pause (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,52);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_activity_pause" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Activity_PermissionResult (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,31);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_raiseevent" /*RemoteObject*/ ,(Object)(b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_gettoppage" /*RemoteObject*/ )),(Object)(BA.ObjectToString("B4XPage_PermissionResult")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_permission),(_result)})));
...
try {
		Debug.PushSubsStack("Activity_Resume (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,48);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_activity_resume" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Create_Menu (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,39);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_createmenu" /*RemoteObject*/ ,(Object)(_menu));
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,4);
...
try {
		Debug.PushSubsStack("MainForm_Resize (b4xpagesdelegator) ","b4xpagesdelegator",22,__ref.getField(false, "ba"),__ref,44);
...
Debug.JustUpdateDeviceLine();
b4xpagesdelegator._b4xpages.runMethod(false,"_getmanager" /*RemoteObject*/ ,__ref.runMethod(false,"getActivityBA")).runClassMethod (com.detektor.kateenapp.b4xpagesmanager.class, "_mainform_resize" /*RemoteObject*/ ,(Object)(_width),(Object)(_height));
