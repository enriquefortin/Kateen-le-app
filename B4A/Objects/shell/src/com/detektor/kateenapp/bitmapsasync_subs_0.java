...
try {
		Debug.PushSubsStack("Initialize (bitmapsasync) ","bitmapsasync",24,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("LoadFromFile (bitmapsasync) ","bitmapsasync",24,__ref.getField(false, "ba"),__ref,48);
...
public ResumableSub_LoadFromFile(com.detektor.kateenapp.bitmapsasync parent,RemoteObject __ref,RemoteObject _dir,RemoteObject _filename,RemoteObject _maxwidth,RemoteObject _maxheight) {
this.parent = parent;
this.__ref = __ref;
this._dir = _dir;
...
try {
		Debug.PushSubsStack("LoadFromHttpJob (bitmapsasync) ","bitmapsasync",24,__ref.getField(false, "ba"),__ref,20);
...
public ResumableSub_LoadFromHttpJob(com.detektor.kateenapp.bitmapsasync parent,RemoteObject __ref,RemoteObject _job,RemoteObject _maxwidth,RemoteObject _maxheight) {
this.parent = parent;
this.__ref = __ref;
this._job = _job;
this._maxwidth = _maxwidth;
...
Debug.JustUpdateDeviceLine();
_sf = __ref.getField(false,"_jme" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("loadBitmap")),(Object)(RemoteObject.createNewArray("Object",new int[] {4},new Object[] {(_job.runClassMethod (com.detektor.kateenapp.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject()),(_job.runClassMethod (com.detektor.kateenapp.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject()),(_maxwidth),(_maxheight)})));Debug.locals.put("sf", _sf);Debug.locals.put("sf", _sf);
