...
RemoteObject _res = RemoteObject.declareNull("com.xjobfinderjrdc2.main._dbresult");
RemoteObject _cmd = RemoteObject.declareNull("com.xjobfinderjrdc2.main._dbcommand");
...
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _ser.runMethod(false,"ConvertBytesToObject",(Object)(rdchandler.__c.getField(false,"Bit").runMethod(false,"InputStreamToBytes",(Object)((_in.getObject()))))));Debug.locals.put("m", _m);Debug.locals.put("m", _m);
...
_commands = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _m.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("commands")))));Debug.locals.put("commands", _commands);Debug.locals.put("commands", _commands);
 BA.debugLineNum = 101;BA.debugLine="Dim res As DBResult";
Debug.ShouldStop(16);
_res = RemoteObject.createNew ("com.xjobfinderjrdc2.main._dbresult");Debug.locals.put("res", _res);
...
_con.runVoidMethod ("ExecNonQuery2",(Object)(rdchandler._main._rdcconnector1 /*RemoteObject*/ .runClassMethod (com.xjobfinderjrdc2.rdcconnector.class, "_getcommand" /*RemoteObject*/ ,(Object)(_cmd.getField(true,"Name" /*RemoteObject*/ )))),(Object)(rdchandler.__c.runMethod(false, "ArrayToList", (Object)(_cmd.getField(false,"Parameters" /*RemoteObject*/ )))));
 }
}Debug.locals.put("cmd", _cmd);
;
...
rdchandler.__c.runVoidMethod ("LogImpl","4786451",BA.ObjectToString(rdchandler.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
...
_rs = _con.runMethod(false,"ExecQuery2",(Object)(rdchandler._main._rdcconnector1 /*RemoteObject*/ .runClassMethod (com.xjobfinderjrdc2.rdcconnector.class, "_getcommand" /*RemoteObject*/ ,(Object)(_cmd.getField(true,"Name" /*RemoteObject*/ )))),(Object)(rdchandler.__c.runMethod(false, "ArrayToList", (Object)(_cmd.getField(false,"Parameters" /*RemoteObject*/ )))));Debug.locals.put("rs", _rs);Debug.locals.put("rs", _rs);
...
_limit = BA.numberCast(int.class, ((int)0x7fffffff));Debug.locals.put("limit", _limit);};
...
_jrs = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _rs.getObject());Debug.locals.put("jrs", _jrs);Debug.locals.put("jrs", _jrs);
...
_rsmd = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _jrs.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getMetaData")),(Object)((rdchandler.__c.getField(false,"Null")))));Debug.locals.put("rsmd", _rsmd);Debug.locals.put("rsmd", _rsmd);
...
Debug.ShouldStop(8388608);
_con = rdchandler._main._rdcconnector1 /*RemoteObject*/ .runClassMethod (com.xjobfinderjrdc2.rdcconnector.class, "_getconnection" /*RemoteObject*/ );Debug.locals.put("con", _con);
...
Debug.ShouldStop(33554432);
_q = __ref.runClassMethod (com.xjobfinderjrdc2.rdchandler.class, "_executequery2" /*RemoteObject*/ ,(Object)(_con),(Object)(_in),(Object)(_resp));Debug.locals.put("q", _q);
 }else 
...
Debug.ShouldStop(8);
_q = __ref.runClassMethod (com.xjobfinderjrdc2.rdchandler.class, "_executebatch2" /*RemoteObject*/ ,(Object)(_con),(Object)(_in),(Object)(_resp));Debug.locals.put("q", _q);
 }else {
 BA.debugLineNum = 38;BA.debugLine="Log(\"Unknown method: \" & method)";
Debug.ShouldStop(32);
rdchandler.__c.runVoidMethod ("LogImpl","4655382",RemoteObject.concat(RemoteObject.createImmutable("Unknown method: "),_method),0);
...
Debug.ShouldStop(512);
rdchandler.__c.runVoidMethod ("LogImpl","4655386",BA.ObjectToString(rdchandler.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
...
Debug.ShouldStop(8192);
rdchandler.__c.runVoidMethod ("LogImpl","4655390",(RemoteObject.concat(RemoteObject.createImmutable("Command: "),rdchandler.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_q))),RemoteObject.createImmutable(", took: "),rdchandler.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((RemoteObject.solve(new RemoteObject[] {rdchandler.__c.getField(false,"DateTime").runMethod(true,"getNow"),_start}, "-",1, 2)))),RemoteObject.createImmutable("ms, client="),rdchandler.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_req.runMethod(true,"getRemoteAddress")))),RemoteObject.createImmutable(""))),0);
