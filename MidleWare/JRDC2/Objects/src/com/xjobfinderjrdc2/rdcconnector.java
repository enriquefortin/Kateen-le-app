...
public class rdcconnector extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("com.xjobfinderjrdc2", "com.xjobfinderjrdc2.rdcconnector", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.xjobfinderjrdc2.rdcconnector.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("2327682","*** Command not found: "+_key,0);
 };
