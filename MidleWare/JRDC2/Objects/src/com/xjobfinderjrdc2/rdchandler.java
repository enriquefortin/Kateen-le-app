...
public class rdchandler extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("com.xjobfinderjrdc2", "com.xjobfinderjrdc2.rdchandler", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.xjobfinderjrdc2.rdchandler.class).invoke(this, new Object[] {null});
        else
...
public com.xjobfinderjrdc2.main _main = null;
...
com.xjobfinderjrdc2.main._dbresult _res = null;
com.xjobfinderjrdc2.main._dbcommand _cmd = null;
byte[] _data = null;
...
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_ser.ConvertBytesToObject(__c.Bit.InputStreamToBytes((java.io.InputStream)(_in.getObject())))));
...
_commands = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_m.Get((Object)("commands"))));
 //BA.debugLineNum = 101;BA.debugLine="Dim res As DBResult";
_res = new com.xjobfinderjrdc2.main._dbresult();
...
_cmd = (com.xjobfinderjrdc2.main._dbcommand)(group11.Get(index11));
 //BA.debugLineNum = 109;BA.debugLine="con.ExecNonQuery2(Main.rdcConnector1.GetCommand";
_con.ExecNonQuery2(_main._rdcconnector1 /*com.xjobfinderjrdc2.rdcconnector*/ ._getcommand /*String*/ (_cmd.Name /*String*/ ),anywheresoftware.b4a.keywords.Common.ArrayToList(_cmd.Parameters /*Object[]*/ ));
 }
};
...
_con.TransactionSuccessful();
			...
			ba.setLastException(e17); //BA.debugLineNum = 115;BA.debugLine="con.Rollback";
_con.Rollback();
 //BA.debugLineNum = 116;BA.debugLine="Log(LastException)";
__c.LogImpl("2786451",BA.ObjectToString(__c.LastException(ba)),0);
...
_cmd = (com.xjobfinderjrdc2.main._dbcommand)(_m.Get((Object)("command")));
...
_rs = _con.ExecQuery2(_main._rdcconnector1 /*com.xjobfinderjrdc2.rdcconnector*/ ._getcommand /*String*/ (_cmd.Name /*String*/ ),anywheresoftware.b4a.keywords.Common.ArrayToList(_cmd.Parameters /*Object[]*/ ));
...
_jrs = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_rs.getObject()));
...
_rsmd = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jrs.RunMethod("getMetaData",(Object[])(__c.Null))));
...
_sqltime = _jrs.RunMethodJO(BA.ObjectToString(_datetimemethods.Get((Object)(_ct))),new Object[]{(Object)(_i+1)});
...
_con = _main._rdcconnector1 /*com.xjobfinderjrdc2.rdcconnector*/ ._getconnection /*anywheresoftware.b4j.objects.SQL*/ ();
...
__c.LogImpl("2655382","Unknown method: "+_method,0);
...
__c.LogImpl("2655386",BA.ObjectToString(__c.LastException(ba)),0);
...
__c.LogImpl("2655390",("Command: "+__c.SmartStringFormatter("",(Object)(_q))+", took: "+__c.SmartStringFormatter("",(Object)(__c.DateTime.getNow()-_start))+"ms, client="+__c.SmartStringFormatter("",(Object)(_req.getRemoteAddress()))+""),0);
