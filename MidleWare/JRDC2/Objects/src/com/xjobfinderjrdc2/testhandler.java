...
public class testhandler extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("com.xjobfinderjrdc2", "com.xjobfinderjrdc2.testhandler", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", com.xjobfinderjrdc2.testhandler.class).invoke(this, new Object[] {null});
        else
